...
-- ============================================================
-- Templates 1-5: Original templates (seeded here since
-- 20260228000002 skipped them when table didn't exist yet)
-- ============================================================
...
<td style="width:50%;padding-right:20px;"><p>Resident Signature: ____________________________</p><p>Printed Name: {{resident_name}}</p><p>Date: ____________________________</p></td>
<td style="width:50%;padding-left:20px;"><p>Facility Representative: ____________________________</p><p>Printed Name: {{facility_rep_name}}</p><p>Title: {{facility_rep_title}}</p><p>Date: ____________________________</p></td>
</tr></table></div>',
  '[{"name":"facility_name","label":"Facility Name","type":"text","required":true,"default_value":""},{"name":"facility_address","label":"Facility Address","type":"text","required":true,"default_value":""},{"name":"agreement_date","label":"Agreement Date","type":"date","required":true,"default_value":""},{"name":"resident_name","label":"Resident Full Name","type":"text","required":true,"default_value":""},{"name":"move_in_date","label":"Move-In Date","type":"date","required":true,"default_value":""},{"name":"monthly_rent","label":"Monthly Rent ($)","type":"number","required":true,"default_value":"800"},{"name":"rent_due_day","label":"Rent Due Day (e.g. 1st)","type":"text","required":true,"default_value":"1st"},{"name":"deposit_amount","label":"Security Deposit ($)","type":"number","required":true,"default_value":"800"},{"name":"curfew_time","label":"Weekday Curfew Time","type":"text","required":true,"default_value":"10:00 PM"},{"name":"weekend_curfew","label":"Weekend Curfew Time","type":"text","required":true,"default_value":"11:00 PM"},{"name":"meetings_per_week","label":"Required Meetings Per Week","type":"number","required":true,"default_value":"3"},{"name":"notice_days","label":"Notice Period (days)","type":"number","required":true,"default_value":"30"},{"name":"facility_rep_name","label":"Facility Rep Name","type":"text","required":true,"default_value":""},{"name":"facility_rep_title","label":"Facility Rep Title","type":"text","required":true,"default_value":"House Manager"}]'::jsonb
...
VALUES (
  ...
  'house_rules',
  '<div class="document"><h1 style="text-align:center;">HOUSE RULES ACKNOWLEDGMENT</h1><h2 style="text-align:center;">{{facility_name}}</h2><hr/><p>I, <strong>{{resident_name}}</strong>, acknowledge that I have received, read, and understood the House Rules of {{facility_name}}. I agree to abide by all rules as a condition of my residency.</p><h3>SUMMARY OF KEY RULES</h3><ul><li><strong>Sobriety:</strong> Zero tolerance for alcohol, illegal drugs, or non-prescribed medications on premises or in your system.</li><li><strong>Drug Testing:</strong> Submit to random drug and alcohol testing upon request at any time.</li><li><strong>Curfew:</strong> {{curfew_time}} weekdays, {{weekend_curfew}} weekends. Notify house manager if you will be late.</li><li><strong>Recovery Meetings:</strong> Attend minimum {{meetings_per_week}} meetings per week. Provide signed verification slips.</li><li><strong>Guests:</strong> All guests must be approved by house manager. No overnight guests without prior written approval.</li><li><strong>Chores:</strong> Complete your assigned chores daily. The house must be kept clean at all times.</li><li><strong>Rent:</strong> Rent is due on the {{rent_due_day}} of each month. Late fees apply after 3 days.</li><li><strong>Respect:</strong> Treat all housemates and staff with respect. Physical or verbal aggression results in immediate removal.</li><li><strong>Prohibited Items:</strong> No weapons, drug paraphernalia, pornography, or alcohol on premises.</li><li><strong>Medications:</strong> All medications must be stored in your assigned lockbox and self-administered per policy.</li></ul><p style="margin-top:20px;">I understand that violation of these rules may result in immediate termination of my residency without refund of deposit.</p><div style="margin-top:40px;"><p>Resident Signature: ____________________________  Date: ______________</p><p>Printed Name: {{resident_name}}</p><p>House Manager Signature: ________________________  Date: ______________</p></div></div>',
  '[{"name":"facility_name","label":"Facility Name","type":"text","required":true,"default_value":""},{"name":"resident_name","label":"Resident Full Name","type":"text","required":true,"default_value":""},{"name":"curfew_time","label":"Weekday Curfew Time","type":"text","required":true,"default_value":"10:00 PM"},{"name":"weekend_curfew","label":"Weekend Curfew Time","type":"text","required":true,"default_value":"11:00 PM"},{"name":"meetings_per_week","label":"Required Meetings Per Week","type":"number","required":true,"default_value":"3"},{"name":"rent_due_day","label":"Rent Due Day","type":"text","required":true,"default_value":"1st"}]'::jsonb
) ON CONFLICT (id) DO NOTHING;
...
VALUES (
  ...
  'Incident Report',
  'incident_report',
  '<div class="document"><h1 style="text-align:center;">INCIDENT REPORT</h1><h2 style="text-align:center;">{{facility_name}}</h2><hr/><table style="width:100%;border-collapse:collapse;"><tr><td style="width:50%;padding:4px;"><strong>Date of Incident:</strong> {{incident_date}}</td><td style="width:50%;padding:4px;"><strong>Time of Incident:</strong> {{incident_time}}</td></tr><tr><td style="padding:4px;"><strong>Location:</strong> {{incident_location}}</td><td style="padding:4px;"><strong>Report Date:</strong> {{report_date}}</td></tr><tr><td style="padding:4px;"><strong>Resident(s) Involved:</strong> {{residents_involved}}</td><td style="padding:4px;"><strong>Staff on Duty:</strong> {{staff_on_duty}}</td></tr><tr><td colspan="2" style="padding:4px;"><strong>Incident Type:</strong> {{incident_type}}</td></tr></table><h3>DESCRIPTION OF INCIDENT</h3><div style="border:1px solid #ccc;min-height:100px;padding:10px;"><p>{{incident_description}}</p></div><h3>ACTIONS TAKEN</h3><div style="border:1px solid #ccc;min-height:80px;padding:10px;"><p>{{actions_taken}}</p></div><h3>NOTIFICATIONS MADE</h3><ul><li>911/Emergency Services: {{notified_911}}</li><li>Management/Owner: {{notified_management}}</li><li>ADHS (if required): {{notified_adhs}}</li><li>Family/Guardian: {{notified_family}}</li></ul><h3>FOLLOW-UP REQUIRED</h3><div style="border:1px solid #ccc;min-height:60px;padding:10px;"><p>{{follow_up}}</p></div><div style="margin-top:40px;"><p>Reporting Staff Signature: ____________________________  Date: ______________</p><p>Printed Name: {{staff_on_duty}}</p><p>Supervisor Review Signature: ________________________  Date: ______________</p></div></div>',
  '[{"name":"facility_name","label":"Facility Name","type":"text","required":true,"default_value":""},{"name":"incident_date","label":"Date of Incident","type":"date","required":true,"default_value":""},{"name":"incident_time","label":"Time of Incident","type":"text","required":true,"default_value":""},{"name":"incident_location","label":"Location in Facility","type":"text","required":true,"default_value":""},{"name":"report_date","label":"Date of Report","type":"date","required":true,"default_value":""},{"name":"residents_involved","label":"Resident(s) Involved","type":"text","required":true,"default_value":""},{"name":"staff_on_duty","label":"Staff on Duty","type":"text","required":true,"default_value":""},{"name":"incident_type","label":"Type of Incident","type":"text","required":true,"default_value":""},{"name":"incident_description","label":"Description of Incident","type":"textarea","required":true,"default_value":""},{"name":"actions_taken","label":"Actions Taken","type":"textarea","required":true,"default_value":""},{"name":"notified_911","label":"911 Notified?","type":"text","required":true,"default_value":"No"},{"name":"notified_management","label":"Management Notified?","type":"text","required":true,"default_value":"Yes"},{"name":"notified_adhs","label":"ADHS Notified?","type":"text","required":true,"default_value":"No"},{"name":"notified_family","label":"Family Notified?","type":"text","required":true,"default_value":"No"},{"name":"follow_up","label":"Follow-Up Required","type":"textarea","required":false,"default_value":"None required at this time."}]'::jsonb
) ON CONFLICT (id) DO NOTHING;
...
VALUES (
  ...
  'other',
  '<div class="document"><h1 style="text-align:center;">30-DAY NOTICE TO VACATE</h1><h2 style="text-align:center;">{{facility_name}}</h2><p style="text-align:center;">{{facility_address}}</p><hr/><p><strong>Date:</strong> {{notice_date}}</p><p><strong>To:</strong> {{resident_name}}</p><p><strong>Re:</strong> Notice to Vacate Premises</p><p>Dear {{resident_name}},</p><p>This letter serves as formal written notice that your residency at <strong>{{facility_name}}</strong>, located at {{facility_address}}, will be terminated effective <strong>{{vacate_date}}</strong>, which is 30 days from the date of this notice.</p><p><strong>Reason for Notice:</strong></p><div style="border-left:4px solid #ccc;padding-left:16px;margin:16px 0;"><p>{{reason_for_notice}}</p></div><p>You are required to:</p><ol><li>Remove all personal belongings from the premises by <strong>{{vacate_date}}</strong> at <strong>{{vacate_time}}</strong>.</li><li>Return all keys, access cards, and facility-issued items to the house manager.</li><li>Leave your room in clean condition for move-out inspection.</li><li>Settle any outstanding rent balance of <strong>${{balance_owed}}</strong> prior to departure.</li></ol><p>Your security deposit of <strong>${{deposit_amount}}</strong> will be returned within 14 days of your departure, less any deductions for damages or outstanding rent, per the terms of your Resident Agreement.</p><p>If you have questions regarding this notice, please contact <strong>{{contact_name}}</strong> at <strong>{{contact_phone}}</strong>.</p><div style="margin-top:40px;"><p>Facility Representative: ____________________________  Date: ______________</p><p>Printed Name: {{contact_name}}</p><p>Title: {{contact_title}}</p><br/><p>Resident Acknowledgment: ___________________________  Date: ______________</p><p>Printed Name: {{resident_name}}</p></div></div>',
  '[{"name":"facility_name","label":"Facility Name","type":"text","required":true,"default_value":""},{"name":"facility_address","label":"Facility Address","type":"text","required":true,"default_value":""},{"name":"notice_date","label":"Date of Notice","type":"date","required":true,"default_value":""},{"name":"resident_name","label":"Resident Full Name","type":"text","required":true,"default_value":""},{"name":"vacate_date","label":"Required Vacate Date","type":"date","required":true,"default_value":""},{"name":"vacate_time","label":"Required Vacate Time","type":"text","required":true,"default_value":"12:00 PM"},{"name":"reason_for_notice","label":"Reason for Notice","type":"textarea","required":true,"default_value":""},{"name":"balance_owed","label":"Outstanding Balance ($)","type":"number","required":true,"default_value":"0"},{"name":"deposit_amount","label":"Security Deposit Amount ($)","type":"number","required":true,"default_value":"0"},{"name":"contact_name","label":"Contact Name","type":"text","required":true,"default_value":""},{"name":"contact_phone","label":"Contact Phone","type":"text","required":true,"default_value":""},{"name":"contact_title","label":"Contact Title","type":"text","required":true,"default_value":"House Manager"}]'::jsonb
) ON CONFLICT (id) DO NOTHING;
...
VALUES (
  ...
  'consent',
  '<div class="document"><h1 style="text-align:center;">RESIDENT GRIEVANCE FORM</h1><h2 style="text-align:center;">{{facility_name}}</h2><hr/><p><strong>Date Submitted:</strong> {{submission_date}}</p><p><strong>Resident Name:</strong> {{resident_name}}</p><p><strong>Room Assignment:</strong> {{room_number}}</p><h3>NATURE OF GRIEVANCE</h3><p><em>Check all that apply:</em></p><ul><li>&#9633; Staff conduct or behavior</li><li>&#9633; House rule enforcement</li><li>&#9633; Maintenance or safety issue</li><li>&#9633; Conflict with another resident</li><li>&#9633; Financial dispute (rent, fees, deposit)</li><li>&#9633; Discrimination or harassment</li><li>&#9633; Other: {{grievance_type}}</li></ul><h3>DESCRIPTION OF GRIEVANCE</h3><div style="border:1px solid #ccc;min-height:120px;padding:10px;"><p>{{grievance_description}}</p></div><h3>DESIRED RESOLUTION</h3><div style="border:1px solid #ccc;min-height:80px;padding:10px;"><p>{{desired_resolution}}</p></div><h3>WITNESSES (if any)</h3><p>{{witnesses}}</p><p style="margin-top:20px;font-style:italic;">This grievance will be reviewed within 5 business days. You will receive a written response. Filing this grievance will not result in any retaliation.</p><div style="margin-top:40px;"><p>Resident Signature: ____________________________  Date: ______________</p><p>Received By: ____________________________  Date: ______________</p><p>Resolution Date: ____________________________</p><p>Resolution Notes: ____________________________</p></div></div>',
  '[{"name":"facility_name","label":"Facility Name","type":"text","required":true,"default_value":""},{"name":"submission_date","label":"Date Submitted","type":"date","required":true,"default_value":""},{"name":"resident_name","label":"Resident Full Name","type":"text","required":true,"default_value":""},{"name":"room_number","label":"Room Assignment","type":"text","required":false,"default_value":""},{"name":"grievance_type","label":"Type of Grievance (if Other)","type":"text","required":false,"default_value":""},{"name":"grievance_description","label":"Description of Grievance","type":"textarea","required":true,"default_value":""},{"name":"desired_resolution","label":"Desired Resolution","type":"textarea","required":false,"default_value":""},{"name":"witnesses","label":"Witnesses (names)","type":"text","required":false,"default_value":"None"}]'::jsonb
) ON CONFLICT (id) DO NOTHING;
